...
APP_NAME = iot-button-emulator
APP_SRC_FILES = $(APP_NAME).cpp clickButton.cpp
...
LD_FLAG += -ldl $(TLS_LIB_DIR)/libmbedtls.a $(TLS_LIB_DIR)/libmbedcrypto.a $(TLS_LIB_DIR)/libmbedx509.a -lpthread -lwiringPi
